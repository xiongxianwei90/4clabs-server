...
// Validate checks the field values on ListAboutMineComicWorkRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, an error is returned.
func (m *ListAboutMineComicWorkRequest) Validate() error {
	if m == nil {
		return nil
	}
	...
	if v, ok := interface{}(m.GetBaseListRequest()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return ListAboutMineComicWorkRequestValidationError{
				field:  "BaseListRequest",
				reason: "embedded message failed validation",
				cause:  err,
			}
...
// ListAboutMineComicWorkRequestValidationError is the validation error
// returned by ListAboutMineComicWorkRequest.Validate if the designated
// constraints aren't met.
type ListAboutMineComicWorkRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListAboutMineComicWorkRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListAboutMineComicWorkRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListAboutMineComicWorkRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListAboutMineComicWorkRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListAboutMineComicWorkRequestValidationError) ErrorName() string {
	return "ListAboutMineComicWorkRequestValidationError"
}

// Error satisfies the builtin error interface
func (e ListAboutMineComicWorkRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListAboutMineComicWorkRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListAboutMineComicWorkRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListAboutMineComicWorkRequestValidationError{}

// Validate checks the field values on ListAboutMineComicWorkResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, an error is returned.
func (m *ListAboutMineComicWorkResponse) Validate() error {
	if m == nil {
		return nil
	}
	...
	if v, ok := interface{}(m.GetBaseListResponse()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return ListAboutMineComicWorkResponseValidationError{
				field:  "BaseListResponse",
				reason: "embedded message failed validation",
				cause:  err,
			}
...
// ListAboutMineComicWorkResponseValidationError is the validation error
// returned by ListAboutMineComicWorkResponse.Validate if the designated
// constraints aren't met.
type ListAboutMineComicWorkResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListAboutMineComicWorkResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListAboutMineComicWorkResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListAboutMineComicWorkResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListAboutMineComicWorkResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListAboutMineComicWorkResponseValidationError) ErrorName() string {
	return "ListAboutMineComicWorkResponseValidationError"
}

// Error satisfies the builtin error interface
func (e ListAboutMineComicWorkResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListAboutMineComicWorkResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListAboutMineComicWorkResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListAboutMineComicWorkResponseValidationError{}
