...
var file_api_service_v1_service_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x69, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x1a, 0x14,
	...
	0x02, 0x0a, 0x03, 0x4e, 0x66, 0x74, 0x12, 0x7a, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x41, 0x64, 0x64,
...
var file_api_service_v1_service_proto_goTypes = []interface{}{
	(*v1.GetAddressNftsRequest)(nil), // 0: api.nft.v1.GetAddressNftsRequest
	(*v1.GetNftDetailRequest)(nil),   // 1: api.nft.v1.GetNftDetailRequest
	(*v1.GetAddressNftResponse)(nil), // 2: api.nft.v1.GetAddressNftResponse
	(*v1.GetNftDetailResponse)(nil),  // 3: api.nft.v1.GetNftDetailResponse
}
var file_api_service_v1_service_proto_depIdxs = []int32{
	0, // 0: api.service.v1.Nft.GetAddressNfts:input_type -> api.nft.v1.GetAddressNftsRequest
	1, // 1: api.service.v1.Nft.GetNftDetail:input_type -> api.nft.v1.GetNftDetailRequest
	2, // 2: api.service.v1.Nft.GetAddressNfts:output_type -> api.nft.v1.GetAddressNftResponse
	3, // 3: api.service.v1.Nft.GetNftDetail:output_type -> api.nft.v1.GetNftDetailResponse
