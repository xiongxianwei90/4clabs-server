...
func newUser(db *gorm.DB) user {
	...
	_user.Nonce = field.NewString(tableName, "nonce")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Nonce = field.NewString(table, "nonce")
...
func (u userDo) ReadDB(ctx context.Context) *userDo {
	return u.WithContext(ctx).Clauses(dbresolver.Read)
}

func (u userDo) WriteDB(ctx context.Context) *userDo {
	return u.WithContext(ctx).Clauses(dbresolver.Write)
}
